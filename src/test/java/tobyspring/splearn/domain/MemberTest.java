...
class MemberTest {
    ...
    void invalidEmail() {
        assertThatThrownBy(() ->
                Member.create(new MemberCreateRequest("kim", "shin", "secret"), passwordEncoder)
        ).isInstanceOf(IllegalArgumentException.class);

        Member.create(new MemberCreateRequest("kim@splearn.app", "shin", "secret"), passwordEncoder);
    }
}
